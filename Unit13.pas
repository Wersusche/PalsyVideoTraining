    ...
    begin
      ...
      begin
        ...
        FDQuery.ExecSQL;
         ...
         begin
         UserChoice := MessageDlg('Имеются временные пересечения с существующими записями в таблице у упражнения "' +
         TreeItem.Text + '" в период с ' + datetostr(StartDate) + ' по ' + datetostr(EndDate) + '. Вы уверены, что хотите внести запись?',
